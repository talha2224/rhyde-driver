...
const VerifyLicense = () => {
  ...
  const handleNext = () => {
    if (!licenseImageUri) {
      Alert.alert('Missing License', 'Please upload your driver\'s license to continue.');
      return;
    }
