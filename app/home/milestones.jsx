    ...
    <View style={styles.container}>
      ...
      <ScrollView contentContainerStyle={styles.scrollViewContent}>
        ...
        <View style={styles.currentLevelCard}>
          <Text style={styles.currentLevelTitle}>Level 20 <Text style={styles.currentLevelSubtitle}>(You've completed 10 rydes this week)</Text></Text>
          <View style={styles.progressBarBackground}>
            <View style={styles.progressBarFill} />
          </View>
          <Text style={styles.progressText}>Complete 14/20 rydes</Text>
        </View>
