...
const VehicleInformationScreen = () => {
        ...
        <ScrollView contentContainerStyle={styles.tabContent}>
            ...
            <View style={styles.carDetailsGrid}>
                ...
                <View style={styles.carDetailBox}>
                    ...
                    <Text style={styles.carDetailValue}>{vehicleDetails.numberOfSeats}</Text>
                </View>
                <View style={styles.carDetailBox}>
                    <Text style={styles.carDetailLabel}>Years of usage</Text>
                    <Text style={styles.carDetailValue}>{vehicleDetails.yearsOfUsage}</Text>
                </View>
            </View>
        </ScrollView>
    );
    ...
    return (
        <View style={styles.container}>
            ...
            <View style={{ backgroundColor: "#2A2A2A", marginHorizontal: 20, marginBottom: 20, borderRadius: 10 }}>
                <Image source={vehicleDetails.carImage} style={styles.carImage} resizeMode="contain" />
            </View>

            <View style={styles.tabContainer}>
                {['Car Details', 'Vehicle documents', 'Driver\'s License'].map((tab) => (
                    <TouchableOpacity key={tab} style={[styles.tabButton, activeTab === tab && styles.activeTabButton]} onPress={() => setActiveTab(tab)}>
                        <Text numberOfLines={1} style={[styles.tabButtonText, activeTab === tab && styles.activeTabButtonText]}>{tab}</Text>
                    </TouchableOpacity>
                ))}
            </View>
