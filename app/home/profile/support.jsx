    ...
    <View style={styles.container}>
      ...
      <ScrollView contentContainerStyle={styles.scrollViewContent}>
        <View style={styles.supportInfo}>
          ...
          <Text style={styles.supportHelperText}>How can we help you, do you have a question? 95% of question can be answered in the F.A.Q’s below if you can't find your questions please send us a message and we will do our best to answer them accordingly.</Text>
        </View>
